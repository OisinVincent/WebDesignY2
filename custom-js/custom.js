$(document).ready(function(){
    ...
    $("#checkout" ).html(localStorage.getItem('checkout'));
      ...
      if (localStorage.getItem('checkout1') == null) {  
        localStorage.setItem('checkout1',0);
    }
    $("#checkout1" ).html(localStorage.getItem('checkout1'));
...
if (localStorage.getItem('userdetails') === null) {  
    ...
    if (loggedin==1) {
        ...
        $("#loginlogout" ).html("Login"/*localStorage.getItem("userdetails")*/);
    ...
    $('form[name="login"]' ).submit(function( event ) {
        ...
        if (email=="wmitty@email.com" && password=="password1")  {   
            ...
            alert("Welcome back "+ email)// redirect to shop page
        }
        else {
    ...
    $('form[name="paymentdetails"]' ).submit(function( event ) {
        ...
        if (cardnumber=="1234 5678 9102 3456") {
            ...
            $( "#checkout" ).html(total);
            localStorage.setItem('checkout1',total); // makes sure that when we goto another page - the total help in localstorage is zero
            $( "#checkout1" ).html(total);
    ...
    $(".addtocart").click(function(){
       ...
       $(".addtocart").click(function(){
        var total=localStorage.getItem('checkout1');
        total++;
        localStorage.setItem('checkout1',total);
        $("#checkout1" ).html(total );
    });
}); 
(function(){
	document.getElementById("forgotPassword").addEventListener("click", fPassword, false)
}());

function fPassword(){
    document.location.href = 'fPassword.html';
}